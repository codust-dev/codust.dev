  ...
  return (
    <>
      ...
      <div className="relative mb-10 flex items-center justify-center">
        <div className="animate-gradient-x relative w-full overflow-hidden rounded-3xl border-0 bg-gradient-to-br from-blue-900 via-purple-900 to-black shadow-2xl">
          ...
          <div className="relative z-10 px-6 py-12 sm:px-8 sm:py-16">
            <div className="mx-auto max-w-3xl space-y-8 text-center">
              <div className="flex justify-center">
                <div className="rounded-full bg-gradient-to-tr from-blue-500 to-purple-500 p-3 shadow-lg">
                  <FaRocket className="h-10 w-10 text-white drop-shadow-lg" />
                </div>
              </div>
              <h1 className="text-4xl font-extrabold tracking-tight text-white drop-shadow-xl sm:text-5xl md:text-6xl">
                Master the Frontiers of AI
              </h1>
              <p className="mx-auto max-w-2xl text-xl font-medium text-blue-100">
